  ...
  <body>
          ...
          <div class="swipe-to-show">
            <div class="product-list media">
              ...
              <div class="media-body">
                ...
                <span class="title-color font-sm"><span> $25.00</span> <span class="badges-round font-xs">50% off</span></span>
          ...
          <div class="order-detail section-p-t">
            ...
            <ul>
              ...
              <li>
                ...
                <span> <a href="offer.php" class="font-danger">Apply Coupon</a> </span>
              </li>
    ...
    <main class="main-wrap cart-page mb-xxl">
      ...
      <div class="cart-item-wrap pt-0">
        <div class="swipe-to-show">
          <div class="product-list media">
            <a href="product.php"><img src="assets/images/product/8.png" alt="offer" /></a>
            <div class="media-body">
              <a href="product.php" class="font-sm"> Assorted Capsicum Combo </a>
              <span class="content-color font-xs">500g</span>
        ...
        <div class="swipe-to-show active">
          <div class="product-list media">
            <a href="product.php"><img src="assets/images/product/6.png" alt="offer" /></a>
            <div class="media-body">
              <a href="product.php" class="font-sm"> Assorted Capsicum Combo </a>
              <span class="content-color font-xs">500g</span>
              <span class="title-color font-sm">$25.00 <span class="badges-round bg-theme-theme font-xs">50% off</span></span>
        ...
        <div class="swipe-to-show">
          <div class="product-list media">
            <a href="product.php"><img src="assets/images/product/7.png" alt="offer" /></a>
            <div class="media-body">
              <a href="product.php" class="font-sm"> Assorted Capsicum Combo </a>
              <span class="content-color font-xs">500g</span>
        ...
        <div class="swipe-to-show">
          <div class="product-list media">
            <a href="product.php"><img src="assets/images/product/11.png" alt="offer" /></a>
            <div class="media-body">
              <a href="product.php" class="font-sm"> Assorted Capsicum Combo </a>
              <span class="content-color font-xs">500g</span>
              <span class="title-color font-sm">$25.00 <span class="badges-round bg-theme-theme font-xs">50% off</span></span>
    ...
    <footer class="footer-wrap footer-button">
      <a href="address1.php" class="font-md">Proceed to Checkout</a>
    </footer>
    <!-- Footer End -->
...
<!-- Mirrored from themes.pixelstrap.com/fastkart-app/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Feb 2023 10:53:34 GMT -->
</html>
<!-- Html End -->
